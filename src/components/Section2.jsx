            ...
            <div className='pt-10'>
                ...
                <div className='flex flex-wrap justify-between gap-4 pt-6 pb-2'>
                    {SECTION_2_CONTENT.map((content, idx) => {
                        return (
                            <div onClick={() => setActive(idx)} key={idx} className={`border-[1px] bg-white ${active == idx ? 'border-pink shadow-xl ' : 'border-transparent'} rounded-lg w-[160px] aspect-square text-center flex flex-col justify-center items-center`}>
